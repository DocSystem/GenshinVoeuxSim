char* nonFocus5stars[] = {"Jean", "Diluc", "Qiqi", "Keqing", "Mona"};
char* focus5stars = "Hu Tao";

char* all4stars[] = {"Kujou Sara", "Sayu", "Yanfei", "Rosalia", "Xinyan", "Diona", "Sucrose", "Chongyun", "Noëlle", "Bennett", "Fischl", "Ningguang", "Xingqiu", "Beidou", "Xiangling", "Razor", "Barbara", "Thomas"};
char* focus4stars[] = {"Thomas", "Sayu", "Diona"};
char* nonFocus4starsTmp[sizeof(all4stars) / sizeof(all4stars[0])];
